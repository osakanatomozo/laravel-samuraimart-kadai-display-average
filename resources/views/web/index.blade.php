      ...
      <div class="row">
        <div class="col-12">
          <p class="samuraimart-product-label mt-2">
            ...
            <!-- 課題部分 -->
            <span class="samuraimart-star-rating" data-rate="{{round($recommend_product->average_score() * 2) / 2}}"></span>
            <span>{{ $recommend_product->average_score() ?? '0' }}</span><br>
            <!-- 課題部分終わり -->
        ...
        <div class="row">
          <div class="col-12">
            <p class="samuraimart-product-label mt-2">
              ...
              <!-- 課題部分 -->
              <span class="samuraimart-star-rating" data-rate="{{round($recently_product->average_score() * 2) / 2}}"></span>
              <span>{{ $recently_product->average_score() ?? '0' }}</span><br>
              <!-- 課題部分終わり -->
